...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Contenedores para los capítulos de cada libro
        val chaptersLiberAlVelLegis = findViewById<LinearLayout>(R.id.chaptersLiberAlVelLegis)
        val chaptersLiberII = findViewById<LinearLayout>(R.id.chaptersLiberII)
        val chaptersLiberTzaddi = findViewById<LinearLayout>(R.id.chaptersLiberTzaddi)

        // Contenedor para el ScrollView y el TextView
        val scrollView = findViewById<ScrollView>(R.id.scrollView)
        val textView = findViewById<TextView>(R.id.textView)

        textView.movementMethod = ScrollingMovementMethod()  // Habilitar desplazamiento del texto

        // Inicialmente ocultamos todos los contenedores de capítulos
        chaptersLiberAlVelLegis.visibility = View.GONE
        chaptersLiberII.visibility = View.GONE
        chaptersLiberTzaddi.visibility = View.GONE

        // Configuración de los botones
        buttonLiberAlVelLegis.setOnClickListener {
            showChapters("Liber AL vel Legis", chaptersLiberAlVelLegis)
            chaptersLiberAlVelLegis.visibility = View.VISIBLE
            chaptersLiberII.visibility = View.GONE
            chaptersLiberTzaddi.visibility = View.GONE
        }
