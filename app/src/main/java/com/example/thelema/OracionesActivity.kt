...
class OracionesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonRegresar = findViewById<Button>(R.id.buttonRegresar) // Obtén referencia al botón Regresar
        ...
        // Añade OnClickListener al botón Regresar
    ...
    private fun showOraciones(oraciones: List<Pair<String, String>>) {
        ...
        for ((titulo, texto) in oraciones) {
            ...
            tituloTextView.textSize = 18f // Tamaño de letra más grande
            tituloTextView.setPadding(0, 8, 0, 8) // Espacio entre títulos y textos
            contenidoContainer.addView(tituloTextView)

            val textoTextView = TextView(this)
            textoTextView.text = texto
            textoTextView.setPadding(0, 0, 0, 16) // Espacio debajo de cada texto
            contenidoContainer.addView(textoTextView)
        }
    }
}